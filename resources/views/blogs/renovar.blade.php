...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Renovar Boleta</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open(['route' => ['tickets.renew', $originalBoleta->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                            <!-- Mostrar información relevante de la boleta original (si es necesario) -->
                            <div class="row">
                                <div class="col-md-6">
                                    <p><strong>Boleta Original:</strong> {{ $originalBoleta->num_boleta }}</p>
                                    <!-- Agrega más información relevante de la boleta original si es necesario -->
                                </div>
                            </div>
                            <!-- Campos adicionales para la renovación (si es necesario) -->
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="nueva_boleta">Número de Boleta Renovada</label>
                                        {!! Form::text('num_boleta', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el nuevo número de boleta']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
